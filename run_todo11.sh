#!/bin/bash -l
#SBATCH -J todo11
#SBATCH -o /export/home/kaziz/motion/runs/todo11_%j.out
#SBATCH -p gpu-all
...
export T11_N=${T11_N:-256}
export T11_NOPT=${T11_NOPT:-64}
export T11_STEPS=${T11_STEPS:-400}
$CPY todo11_ae_isolate.py
echo "=== TODO11 AE ISOLATION DONE ==="
