#!/bin/bash -l
#SBATCH -J boost_postdecode
#SBATCH -o /export/home/kaziz/motion/runs/boost_postdecode_%j.out
#SBATCH -p gpu-all
...
export SMOOTH_K=${SMOOTH_K:-5}
export EVAL_N=${EVAL_N:-1024}
$CPY boost_postdecode.py
echo "=== BOOST_POSTDECODE DONE ==="
